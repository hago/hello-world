...
def getconfig():
    config = {}
    config["plogdb"] = {}
    config["plogdb"]["host"] = 'localhost'
    #config["plogdb"]["port"] = '3306'
    config["plogdb"]["user"] = 'wordpress'
    config["plogdb"]["pass"] = 'wordpress'
    config["plogdb"]["db"] = 'lifetype128'
    config["plogdb"]["charset"] = 'utf8'
    config["wpdb"] = {}
    config["wpdb"]["host"] = 'localhost'
    #config["wpdb"]["port"] = '3306'
    config["wpdb"]["user"] = 'wordpress'
    config["wpdb"]["pass"] = 'wordpress'
    config["wpdb"]["db"] = 'wp_febonita'
...
def run():
    ...
    for user in users:
        ...
        for row in r:
            ...
            for cat in cats:
                if not categories.has_key(cat[0]):
                    continue;
